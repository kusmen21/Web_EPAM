	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			case ALL_RIGHT:
				...
				request.getSession().setAttribute(ADMIN_INFO_ATTRIBUTE, INFO_USER_UPDATED);
				break;
			case NO_ID:
				request.getSession().setAttribute(ADMIN_ERROR_ATTRIBUTE, NO_ID);
			...
			case NO_FIELDS:
				...
				break;
			case DATA_INCORRECT:
				request.getSession().setAttribute(ADMIN_ERROR_ATTRIBUTE, ERROR_DATA_INCORRECT);
				page = ConfigurationManager.getProperty(UPDATE_USER_PAGE);
				break;
			default:
