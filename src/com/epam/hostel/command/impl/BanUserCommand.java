...
/**
 * Command provides user bans
 */
public class BanUserCommand  extends ExtendedСommand {
	private static Logger log = LogManager.getLogger(BanUserCommand.class);
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) {
		...
		if (userId != null && !userId.isEmpty()) {
			...
			String errorMessage = MessageManager.getProperty(ERROR_ID_EMPTY_MESSAGE);
